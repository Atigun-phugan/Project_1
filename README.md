...
**Make sure you cross-reference your data with your data sources to address any data collection or data entry issues.**
...
[Tim Dwyer](https://www.linkedin.com/in/jtimdwyer/) (former DSI student and TA) put together [this style guide](https://git.generalassemb.ly/DSI-TDA-2/dsi_style_guide). Some recommendations are geared toward future projects (which will include modeling and span multiple notebooks), but generally these are great recommendations.
...
**Materials must be submitted by 9 a.m. on Friday, October 11th.**
...
**Please push the project to your personal Github account and submit a link in the Google form the IA will make available in the Slack channel.**

---

### Presentation Structure

**You must be ready to present your findings during the afternoon of Friday, October 11th.**

- **Must be within time limit - no less than 7 minutes, no more than 10 minutes.**
- Use Powwerpoint or some other visual aid (Google Slides, Keynote, etc).
